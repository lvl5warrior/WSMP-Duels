...
public sealed interface PendingKitSelectReason {
    ...
    record BotDuel1v1(BotDifficulty difficulty) implements PendingKitSelectReason {}

    /** No extra data needed - the actual challenge state lives in
     *  WarManager's pendingByLeader map, keyed by the same player. */
    record WarLeaderAgreement() implements PendingKitSelectReason {}
