...
public class GauntletRun {
    ...
    /** The world this run's arena is actually in - the plugin's single,
     *  static Gauntlet map, never cloned. Only one run is ever active at
     *  a time; anyone else who wants to start one while this is running
     *  waits in the queue instead (see MatchQueue). */
